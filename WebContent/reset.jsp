	...
	<header>
		<nav class="navbar navbar-fixed-top">
			...
			<ul>
				...
				<li class="active"><a href="reset.jsp">Reset Password</a></li>
			</ul>
		</nav>
		<section
			style="position: absolute; top: 0; bottom: 0; left: 0; right: 0; margin: auto;">
			<form class="signup" action="Forgot" method="post">
				...
				<div class="signup__field">
					<label for="cars">Question:</label> <select name="question">
						<option value="Favourite food?">Favourite food?</option>
						<option value="City where you were born?">City where you
							were born?</option>
						<option value="First elementary school?">First elementary
							school?</option>
					</select> <br>
