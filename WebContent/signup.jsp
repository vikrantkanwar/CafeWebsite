	...
	<header>
		<nav class="navbar navbar-fixed-top">
			...
			<ul>
				...
				<li class="active"><a href="signup.jsp"><i
		...
		<section
			...
			<form class="signup" action="Signup" method="post">
				...
				<h2>
					Already have an account? <span><a href="login.jsp">Log
							In</a></span>
				</h2>

				<div class="signup__field">
					<input class="signup__input" type="text" name="username"
...
<select name="question">
  ...
  <option value="First elementary school?">First elementary school?</option>
</select>
<br><input type="text" name="answer" required placeholder="Your answer">
